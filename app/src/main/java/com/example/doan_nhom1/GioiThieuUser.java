                ...
                .setValue(userProfile1).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(GioiThieuUser.this,"Giới tính đã cập nhật!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private void update_date(){
        ...
        FirebaseDatabase.getInstance().getReference("Users")
                ...
                .setValue(userProfile1).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(GioiThieuUser.this,"Ngày sinh đã cập nhật!", Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
