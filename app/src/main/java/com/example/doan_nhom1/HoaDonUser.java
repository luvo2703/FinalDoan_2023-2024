...
import com.example.doan_nhom1.model.SanPham_Favorite;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    .setValue(hoaDon).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(HoaDonUser.this, "Thêm món thành công!", Toast.LENGTH_LONG).show();
        ...
        reference.child(FirebaseAuth.getInstance().getCurrentUser().getUid())
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(HoaDonUser.this, "Truy cập danh sách lỗi!", Toast.LENGTH_LONG).show();
            }
        });
