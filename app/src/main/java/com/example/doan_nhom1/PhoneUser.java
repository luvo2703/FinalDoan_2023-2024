    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference.child(userID).child("User").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(PhoneUser.this,"Xãy ra 1 số lỗi!", Toast.LENGTH_LONG).show();
            }
        });
                    ...
                    .setValue(userProfile1).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(PhoneUser.this,"Số điện thoại người dùng được cập nhật!", Toast.LENGTH_LONG).show();
